...
public class DataMobilItem{
	...
	private List<PemilikMobilItem> pemilikMobil;
	...
	public void setPemilikMobil(List<PemilikMobilItem> pemilikMobil){
		this.pemilikMobil = pemilikMobil;
	}

	public List<PemilikMobilItem> getPemilikMobil(){
		return pemilikMobil;
	}
